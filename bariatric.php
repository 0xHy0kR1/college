            ...
            <div class="row gx-5">
                <div class="col-lg-5 mb-5 mb-lg-0" style="max-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded" src="img/b1.jpg" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="mb-4">
                        
                        <h1 class="display-4">Bariatric Surgery</h1>
                        <h5 class="d-inline-block text-primary text-uppercase border-bottom border-5">What is bariatric surgery?</h5>
                    </div>
                    <p>Bariatric surgery is a surgical procedure of the digestive system to promote weight-loss in people with severe obesity. Also called as weight-loss surgery, it is recommended to severely obese patients with a BMI above 40, when conventional strategies have failed.</p>
                     
                       <div class="mb-4">
                        
                        <h5 class="d-inline-block text-primary text-uppercase border-bottom border-5">Types of bariatric surgery</h5>
                    </div>
                    <p>Bariatric surgeries aim at reducing the food intake and increasing early satiety. This is achieved by different procedures as mentioned below:</p>
                    <p><b>Laparoscopic adjustable gastric banding (LAGB) surgery</b> - A small pouch is created with the help of a band to minimize food intake and increase satiety.</p>
                  
                    <p><b>Gastric balloon surgery</b> -  A balloon is placed inside the stomach to promote early satisfaction.</p>
                    <p><b>Roux-en-Y gastric bypass surgery</b> - A small pouch is placed that bypasses stomach and duodenum. The bypass mechanism is believed to cause changes in the gut hormones, and hence promote satiety and suppress hunger.</p>
                   <p><b>Vertical sleeve gastrectomy</b> - A portion of the stomach is removed to form a narrower gastric sleeve.</p>
                    <div class="mb-4">
                        
                        <h5 class="d-inline-block text-primary text-uppercase border-bottom border-5">How much does bariatric surgery cost in India?</h5>
                    </div>  
                    <p>The average cost of Bariatric surgery in India is approximately Rs. 210000/- 560000/-. However, the prices may vary depending upon the hospitals in different cities.</p>
                    <p>The cost of Bariatric surgery in Hyderabad depends upon multiple factors and ranges from Rs.2,45,000 – 3,40,000</p>
