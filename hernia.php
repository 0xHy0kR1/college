            ...
            <div class="row gx-5">
                <div class="col-lg-5 mb-5 mb-lg-0" style="max-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100 rounded" src="img/h1.jpg" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="mb-4">
                        
                        <h1 class="display-4">Hernia</h1>
                        <h5 class="d-inline-block text-primary text-uppercase border-bottom border-5">What is hernia?</h5>
                    </div>
                    <p>Hernia is a condition where an organ or fatty tissue pushes through the muscle or tissue holding it. Umbilical hernia and inguinal hernia are the most common types of hernia.

In inguinal hernia, the intestines push through the weak spot or tear out of lower abdominal wall (inguinal canal). Whereas in umbilical hernia, which is mostly seen in children and babies less than 6 months to 1 year old, the part of small intestine push through the abdominal wall near the navel. </p>
                    <div class="mb-4">
                        
                        <h5 class="d-inline-block text-primary text-uppercase border-bottom border-5">What is hernioplasty or hernia repair surgery?</h5>
                    </div>
                     
                   <p>In hernioplasty, the surgeon will remove the hernia by an open surgery or laparoscopic surgery. The surgeon makes a cut to open the skin and gently pushes the hernia back into place and close the weak area of the muscle with stiches with or without a flexible mesh for support. When compared to open surgery, the incision made in the laparoscopic surgery is smaller and offers faster healing and minimal scarring.</p> 
                      
                   <div class="mb-4">
                        <h5 class="d-inline-block text-primary text-uppercase border-bottom border-5">How much does hernia Treatment cost in India?</h5>
                    </div>  
                    <p>The average cost of Hernia Surgery in India is approximately Rs. 18,000 to INR 45,000. However, the prices may vary depending upon the hospitals in different cities..</p>
                    <p>The cost of Hernia Surgery in Hyderabad depends upon multiple factors and ranges from Rs.27,000/- to 45,000/-.</p>
